...
class RadioFieldset extends React.Component {
    static propTypes = {
        ...
        // 用于存储选项值的字段名
        radioValueKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        defaultRadio: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        optionFields: PropTypes.arrayOf(
            PropTypes.shape({
                option: PropTypes.oneOfType([PropTypes.string.isRequired, PropTypes.object.isRequired]),
