...
class ListFieldset extends React.Component{
    ...
    validate = () => {
        ...
        const isValid = range(currentLength).reduce((acc, index) => {
            ...
            return Object.keys(groupFields)
                .reduce((suc, key) => groupFields[key].validate() && suc, true) && acc;
    ...
    getValue = () => {
        ...
        return range(currentLength)
            .map((index) => {
                const groupFields = this.refFields[index];
                return Object.keys(groupFields)
                    .reduce((acc, key) => ({...acc, [key]: groupFields[key].getValue(), }), {});
            });
    }
    ...
    render(){
        ...
        return panelTitle
            ? <Collapse activeKey={this.state.activePanelKey} onChange={(activePanelKey) => {
